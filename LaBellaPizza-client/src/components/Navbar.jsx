...
const Navbar = () => {
  ...
  return (
    ...
    {/* cart items */}
    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle mr-4 lg:flex hidden items-center justify-center">
    ...
    {/*btn*/}
    <a className="btn bg-red rounded-full px-6 text-white flex items-center gap-2"><TbPhoneCall />Contact</a>
  </div>
</div>
